...
export const TopFiveForm = () => {
    ...
    return (
        <form className="topFiveCardForm">
            ...
            <div className="topFiveCardForm__container">
                <fieldset>
                    <div className="form-group">
                        <label htmlFor="name">Title:</label>
                        <input type="text" id="title" onChange={handleInputChange} required autoFocus className="form-control" placeholder="" value={topFive.title} />
                    </div>
                </fieldset>
                <fieldset>
                    <div className="form-group">
                        <label htmlFor="topFiveCardNum1">Number 1: </label>
                        <input type="text" id="num1" onChange={handleInputChange} required className="form-control" placeholder="" value={topFive.num1} ></input>
                    </div>
                </fieldset>
                <fieldset>
                    <div className="form-group">
                        <label htmlFor="topFiveCardNum2">Number 2: </label>
                        <input type="text" id="num2" onChange={handleInputChange} required className="form-control" placeholder="" value={topFive.num2} ></input>
                    </div>
                </fieldset>
                <fieldset>
                    <div className="form-group">
                        <label htmlFor="topFiveCardNum3">Number 3: </label>
                        <input type="text" id="num3" onChange={handleInputChange} required className="form-control" placeholder="" value={topFive.num3} ></input>
                    </div>
                </fieldset>
                <fieldset>
                    <div className="form-group">
                        <label htmlFor="topFiveCardNum4">Number 4: </label>
                        <input type="text" id="num4" onChange={handleInputChange} required className="form-control" placeholder="" value={topFive.num4} ></input>
                    </div>
                </fieldset>
                <fieldset>
                    <div className="form-group">
                        <label htmlFor="topFiveCardNum5">Number 5: </label>
                        <input type="text" id="num5" onChange={handleInputChange} required className="form-control" placeholder="" value={topFive.num5} ></input>
                    </div>
                </fieldset>
